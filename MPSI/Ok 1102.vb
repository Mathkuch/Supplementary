...
Class MainWindow
    ...
    Private Sub Bouton1_Click(sender As Object, e As RoutedEventArgs) Handles Bouton1.Click
        ...
        Select Case pause
            Case 0
                ...
                Dim nTransform As ScaleTransform = New ScaleTransform
                nTransform.ScaleX = 0.75
                nTransform.ScaleY = 0.75

                Canvas1.RenderTransform = nTransform
    ...
    Public Sub dispatcherTimer_Tick(ByVal sender As Object, ByVal e As EventArgs)
        If count < nFp1Array.Count - 1 Then
            ...
            myPrintDialog.PrintTicket.PageOrientation = System.Printing.PageOrientation.Landscape
            myPrintDialog.PrintTicket.PageMediaSize = New PageMediaSize(200, 200)


            'myPrintDialog.PrintTicket.PageScalingFactor = 0.75




            myPrintDialog.PrintVisual(Canvas1, "Form All Controls Print")
        ...
        For e = 0 To 4
            For i As Integer = 0 To 54
                ...
                If Coh > SeuilCoh Then
                    ...
                    End If
                    ListofLine(e)(i).StrokeThickness = 2.5
